...
def parse_args():
    ...
    parser.add_argument('--out_dir', type=str, default='./rawframes')
    parser.add_argument('--frame_path', type=str, default='./rawframes')
    parser.add_argument('--anno_dir', type=str, default='./ucfTrainTestlist')
    parser.add_argument('--out_list_path', type=str, default='./ucfTrainTestlist')
...
def parse_directory(path, key_func=lambda x: x[-11:],
    ...
    """
    print('parsing frames under folder {}'.format(path))
    if level == 1:
